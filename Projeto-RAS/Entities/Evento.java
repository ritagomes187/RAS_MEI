...
public class Evento {
	...
	public String toString() {
		return idEvento+"\t"+
		String.format("%"+(-20)+"s",home_team)+" "+
		String.format("%"+(-20)+"s",resultadoFinal!=null?resultadoFinal:String.format("%.02f, %.02f, %.02f",odd_home, odd_draw, odd_away))+" "+
		String.format("%"+(20)+"s",away_team)+"\t"+data;
	}
